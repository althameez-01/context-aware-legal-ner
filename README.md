...
```bash
git clone https://github.com/althameez-01/context-aware-legal-ner.git
cd context-aware-legal-ner
```
...
For any questions or suggestions, please contact [thameez01@gmail.com]
